...
namespace Hotel_Reservation.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerID, RoomID, CheckInDate, CheckOutDate, NumberOfChildern, NumberOfAdults,TotalPrice,PaymentStatus")] Reservation reservation)
        {
